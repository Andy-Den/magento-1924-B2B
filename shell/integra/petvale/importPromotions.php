...
if ($local == true)
{
	...
	$files[] = file("$testDirectoryImport/promotions/manual_promotions.csv", FILE_IGNORE_NEW_LINES);
} else
{
	$files[] = file("$directoryImport/promotions/promotions.csv", FILE_IGNORE_NEW_LINES);
	$files[] = file("$directoryImport/promotions/manual_promotions.csv", FILE_IGNORE_NEW_LINES);
}
...
function addPromotions($promotions, $storeviewId, $websiteId)
{
	...
	$tiposPromoArray = array(1 => 'promocao', 2 => 'brinde', 3 => 'promocao', 4 => 'promocao');
	...
	foreach ($promotions as $promotion)
	{
		...
		if ($tipoPromocao == 1)
		{
			...
			$description = "{$promotion['percento_desconto']}% de desconto na compra de {$promotion['qtd_minima']} unidades" . (count(explode(',', $promotion['ids_erp'])) > 1 ? ' do MIX' : '');
		...
		} elseif ($tipoPromocao == 2)
		{
			...
			$product = getProductByIdErp($promotion['produtos_bonificados']);
			...
			$description = ("Na compra de {$promotion['qtd_minima']} unidade(s)" . (count(explode(',', $promotion['ids_erp'])) > 1 ? ' do MIX' : '') . ", ganhe mais " . ($promotion['qtd_bonificado']) . " do produto " . '"' . $product->getName() . '"');
		...
		} elseif ($tipoPromocao == 3)
		{
			...
			$description = "{$promotion['percento_desconto']}% de desconto na compra acima de R$ {$promotion['valor_minimo']},00 reais" . (count(explode(',', $promotion['ids_erp'])) > 1 ? ' do MIX' : '');
			$condition = ('\'a:7:{s:4:"type";s:32:"salesrule/rule_condition_combine";s:9:"attribute";N;s:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";s:10:"conditions";a:1:{i:0;a:7:{s:4:"type";s:42:"salesrule/rule_condition_product_subselect";s:9:"attribute";s:14:"base_row_total";s:8:"operator";s:2:">=";s:5:"value";s:' . $sValorMinimo . ':"' . $promotion["valor_minimo"] . '";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";s:10:"conditions";a:1:{i:0;a:5:{s:4:"type";s:32:"salesrule/rule_condition_product";s:9:"attribute";s:6:"id_erp";s:8:"operator";s:2:"()";s:5:"value";s:' . $sIdsErp . ':"' . $promotion['ids_erp'] . '";s:18:"is_value_processed";b:0;}}}}}\'');
			$action = ('\'a:7:{s:4:"type";s:40:"salesrule/rule_condition_product_combine";s:9:"attribute";N;s:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";s:10:"conditions";a:1:{i:0;a:5:{s:4:"type";s:32:"salesrule/rule_condition_product";s:9:"attribute";s:6:"id_erp";s:8:"operator";s:2:"()";s:5:"value";s:'.$sIdsErp.':"'.$promotion['ids_erp'].'";s:18:"is_value_processed";b:0;}}}\'');
		...
		} elseif ($tipoPromocao == 4)
		{
			...
			$description = "{$promotion['percento_desconto']}% de desconto na compra acima de R$ {$promotion['valor_minimo']},00 reais do MIX";
			...
			$action = ('\'a:7:{s:4:"type";s:40:"salesrule/rule_condition_product_combine";s:9:"attribute";N;s:8:"operator";N;s:5:"value";s:1:"1";s:18:"is_value_processed";N;s:10:"aggregator";s:3:"all";s:10:"conditions";a:1:{i:0;a:5:{s:4:"type";s:32:"salesrule/rule_condition_product";s:9:"attribute";s:12:"category_ids";s:8:"operator";s:2:"==";s:5:"value";s:' . $sIdCategoria . ':"' . $promotion['id_categoria'] . '";s:18:"is_value_processed";b:0;}}}\'');
			$values = "VALUES('$nameRule', '$description', STR_TO_DATE('{$promotion['data_inicio']}','%Y/%m/%d'), STR_TO_DATE('{$promotion['data_fim']}','%Y/%m/%d'), 0, 1, $condition, $action, 1, 1, NULL, $priority, 'by_percent', {$promotion['percento_desconto']}, NULL, 0, 0, 0, 0, 1, 1, 0, 0, NULL);";
		}
		...
		if (empty($idRule))
		{
			...
			if ($tipoPromocao == 1)
			{
				...
				{
					$product = getProductByIdErp($item, $storeviewId);
