...
function exportCustomers($websiteId, $storeView) {
    ...
    WHERE ce.website_id = $websiteId AND ce.store_id IN ($storeView) group by ce.entity_id;";

    return $arrayCustomer = $readConnection->fetchAll($sqlCustomer);
}
