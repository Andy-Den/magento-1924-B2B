...
$config = array(
	...
	'especial_lines' => array(
		array (
			...
			array('type' => 'default', 'value' => '1', 'maxsize' => '999'), //Codigo da forma de pagamento
			...
			array('type' => 'default', 'value' => '2'), //Status do pedido
			array('type' => 'dynamic', 'function' => 'getCustomerNote', 'params' => array()),//Coisas que os usuários escreveram
		)
	),
	'items' => array(
		array('type' => 'dynamic', 'function' => 'getProductIdTabela', 'params' => array()),
...
$collection = Mage::getModel('sales/order')
    ...
    //->addAttributeToFilter('entity_id', array('in' => array(655, 656, 657, 658, 659, 660, 661, 662)));
