...
scp -r /wwwroot/integracao/doctorsvet/exporter/customers/* doctorsvet@52.1.2.47:exporter/customers/
...
HORA=`date +%T`
cd /usr/local/bin
echo "Exportação de customers executado em - $DIA/$MES/$ANO - $HORA" >> /wwwroot/integracao/doctorsvet/report/logs/script_customers.log
