...
$codeStore = 'mixpet'; // codigo do SoreView
$storeId = 17; // define em qual Distribuidora a integração vai rodar
$websiteId = 9; // Define o Website ID da distribuidora
$storeviewId = 17; // define em qual view da Distribuidora a integração vai rodar
$stockId = '9'; // define o stock que devereão ser alimentados

$arrayStockId = explode(',', $stockId);
$iStockId = count($arrayStockId);

$storeView = '17'; // Definido para trabalhar em todas views da Abase
$storeViewAll = '17'; // Definido para trabalhar em todas views da Abase

$arrayStoreView = explode(',', $storeView);
$iStoreView = count($arrayStoreView);

$storeViewReps = '17'; // Define os grupos de acessos dos representantes;

$idCategoryCorrigir = 875; // define o ID correspondente `a categoria corrigir da Store
