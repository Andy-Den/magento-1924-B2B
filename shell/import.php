...
/**
 * @category   FVets
 * @package    Fvets_ImportData
 * @license    http://opensource.org/licenses/osl-3.0.php Open Software Licence 3.0 (OSL-3.0)
 * @author     Carlos Eduardo Farah <carlosfarah@gmail.com>
 */
class Fvets_ImportData_Shell_Import extends Mage_Shell_Abstract
{
    /**
     * Run script
     *
    ...
    public function run()
    {
        if ($importTypeCode = $this->getArg('type')) {
            ...
            try {
                ...
                /** @var $import Fvets_ImportData_Model_Import */
                $import = Mage::getModel('fvetsimportdata/import');
...
$shell = new Fvets_ImportData_Shell_Import();
$shell->run();
