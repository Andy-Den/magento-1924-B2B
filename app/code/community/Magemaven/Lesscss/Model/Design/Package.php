 ...
 */
class Magemaven_Lesscss_Model_Design_Package extends TM_Argento_Model_Core_Design_Package
{
    ...
    public function getFilename($file, array $params)
    {
		...
		if (!isset($params['_ignoreless']))
		{
			$params['_ignoreless'] = false;
		}
        ...
        if ($helper->getFileExtension($file) == 'less' && !$params['_ignoreless']) {
