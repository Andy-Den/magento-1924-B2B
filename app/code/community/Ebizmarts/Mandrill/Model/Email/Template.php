...
if(Mage::helper('core')->isModuleEnabled('Aschroder_SMTPPro')){
	class Ebizmarts_Mandrill_Model_Email_Template_Tmp extends Aschroder_SMTPPro_Model_Email_Template {}
} else {
	class Ebizmarts_Mandrill_Model_Email_Template_Tmp extends Mage_Core_Model_Email_Template {}
}

class Ebizmarts_Mandrill_Model_Email_Template extends Ebizmarts_Mandrill_Model_Email_Template_Tmp {
