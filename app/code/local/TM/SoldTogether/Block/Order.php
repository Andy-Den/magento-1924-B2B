...
class TM_SoldTogether_Block_Order extends TM_SoldTogether_Block_Abstract
{
    ...
    protected function _beforeToHtml()
    {
        ...
        if (!Mage::getStoreConfig('soldtogether/general/out_of_stock')) {
			...
			//ajuste feito para que itens não sejam duplicados na query (wharehouse)
			$this->fixWarehouseDistinctStock($collection);
        }
        if (Mage::getStoreConfig('soldtogether/general/random') && !count($collection)) {
