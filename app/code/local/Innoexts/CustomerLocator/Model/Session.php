    ...
    extends Innoexts_Core_Model_Session_Abstract 
{
    ...
    {
        $address                = null;
        $addressHelper          = $this->getCoreHelper()
            ->getAddressHelper();
        $ip                     = $this->getIp();
        if (!$ip) {
            return $address;
        }
        $_address               = $this->getCustomerLocatorHelper()
            ->getGeoIpHelper()
            ->getAddressByIp($ip);
        if (!$_address) {
            return $address;
    ...
    protected function getCustomerDefaultAddress()
    {
        ...
        $_address               = $customerHelper->getCustomer()
    ...
    protected function getDefaultAddress()
    {
        return $this->getCoreHelper()
            ->getAddressHelper()
            ->cast($this->getCustomerLocatorHelper()->getDefaultAddress());
    }
    /**
     * Locate address
     * 
    ...
    public function setCoordinates($coordinates)
    {
        ...
        if ($helper->isCoordinatesGeolocatorEnabled()) {
            $address                = $helper->getGeoCoderHelper()
