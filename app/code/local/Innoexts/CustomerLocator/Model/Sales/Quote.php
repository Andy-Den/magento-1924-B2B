...
if(Mage::helper('core')->isModuleEnabled('Idev_OneStepCheckout')){
	class Innoexts_CustomerLocator_Model_Sales_Quote_Tmp extends Idev_OneStepCheckout_Model_Sales_Quote {}
} else {
	class Innoexts_CustomerLocator_Model_Sales_Quote_Tmp extends Mage_Sales_Model_Quote {}
}

class Innoexts_CustomerLocator_Model_Sales_Quote 
    extends Innoexts_CustomerLocator_Model_Sales_Quote_Tmp
{
    /**
