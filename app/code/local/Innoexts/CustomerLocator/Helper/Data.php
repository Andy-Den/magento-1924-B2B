    ...
    extends Innoexts_Core_Helper_Abstract 
{
    ...
    public function applyCustomerAddressToQuoteAddress($quoteAddress, $overwrite = false)
    {
        ...
        $customerAddressId      = $coreHelper->getCustomerHelper()
    ...
    public function isCoordinatesGeolocatorEnabled()
    {
        ...
        return (
            ...
            !(
                ...
                $customerHelper->getCustomer()->getDefaultShippingAddress()
            ) && 
    ...
    public function isAllowModification()
    {
        return $this->getConfig()
            ->isAllowModification($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->useDefaultShippingAddress($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->useCoordinatesGeolocation($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->useIpGeolocation($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isAdjustAddressOnCheckout($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isCountryAllowed($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isPostcodeAllowed($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isCountryRequired($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isRegionRequired($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isPostcodeRequired($this->getStore());
    }
    /**
    ...
    {
        return $this->getConfig()
            ->isStreetRequired($this->getStore());
    }
    /**
     * Get default address
     * 
    ...
    {
        return $this->getConfig()
            ->getDefaultAddress($this->getStore());
    }
}