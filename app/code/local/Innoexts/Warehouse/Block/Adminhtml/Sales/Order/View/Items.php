...
if(Mage::helper('core')->isModuleEnabled('Idev_OneStepCheckout')){
	class Innoexts_Warehouse_Block_Adminhtml_Sales_Order_View_Items_Tmp extends Idev_OneStepCheckout_Block_Adminhtml_Sales_Order_View_Comment {}
} else {
	class Innoexts_Warehouse_Block_Adminhtml_Sales_Order_View_Items_Tmp extends Mage_Adminhtml_Block_Sales_Order_View_Items {}
}

class Innoexts_Warehouse_Block_Adminhtml_Sales_Order_View_Items 
    extends Innoexts_Warehouse_Block_Adminhtml_Sales_Order_View_Items_Tmp
{
    /**
