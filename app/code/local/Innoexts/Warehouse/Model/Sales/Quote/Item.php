...
if(Mage::helper('core')->isModuleEnabled('Amasty_Promo')){
	class Innoexts_Warehouse_Model_Sales_Quote_Item_Tmp extends  Amasty_Promo_Model_Sales_Quote_Item {}
} else {
	class Innoexts_Warehouse_Model_Sales_Quote_Item_Tmp extends Mage_Sales_Model_Quote_Item {}
}

class Innoexts_Warehouse_Model_Sales_Quote_Item 
    extends Innoexts_Warehouse_Model_Sales_Quote_Item_Tmp
{
    /**
     * Stock item model
     * 
    ...
    {
		#Biscoito
		//Rever essa parte. Existe algum motivo para ter esse if
