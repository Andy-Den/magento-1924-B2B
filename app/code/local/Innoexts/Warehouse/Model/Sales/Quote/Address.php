...
if(Mage::helper('core')->isModuleEnabled('Idev_OneStepCheckout')){
	class Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp extends Idev_OneStepCheckout_Model_Sales_Quote_Address {}
} else if(Mage::helper('core')->isModuleEnabled('FVets_CheckoutSplit')){
    class Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp extends FVets_CheckoutSplit_Model_Sales_Quote_Address {}
} else if(Mage::helper('core')->isModuleEnabled('FVets_Sales')){
    class Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp extends FVets_Sales_Model_Sales_Quote_Address {}
} else if(Mage::helper('core')->isModuleEnabled('Amasty_Promo')){
	class Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp extends Amasty_Promo_Model_Sales_Quote_Address {}
} else if(Mage::helper('core')->isModuleEnabled('Allpago_Installments')){
	class Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp extends Allpago_Installments_Model_Address {}
} else {
	class Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp extends Mage_Sales_Model_Quote_Address {}
}

class Innoexts_Warehouse_Model_Sales_Quote_Address 
    extends Innoexts_Warehouse_Model_Sales_Quote_Address_Tmp
{
    /**
     * Customer model
     *
