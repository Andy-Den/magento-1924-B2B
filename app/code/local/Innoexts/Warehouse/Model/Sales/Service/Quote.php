...
if(Mage::helper('core')->isModuleEnabled('Idev_OneStepCheckout')){
	class Innoexts_Warehouse_Model_Sales_Service_Quote_Tmp extends Idev_OneStepCheckout_Model_Sales_Service_Quote {}
} else {
	class Innoexts_Warehouse_Model_Sales_Service_Quote_Tmp extends Mage_Sales_Model_Service_Quote {}
}

class Innoexts_Warehouse_Model_Sales_Service_Quote 
    extends Innoexts_Warehouse_Model_Sales_Service_Quote_Tmp
{
    /**
     * Orders
     * 
