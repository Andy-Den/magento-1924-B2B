...
$connection->addKey($productIndexBatchPriceTable, 'PRIMARY', array(
    'entity_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexBatchSpecialPriceTable, 'PRIMARY', array(
    'entity_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
if (Mage::helper('warehouse')->getVersionHelper()->isGe1600()) {
    ...
    $connection->addIndex(
        ...
        $installer->getIdxName(
            ...
            array('entity_id', 'all_groups', 'customer_group_id', 'qty', 'website_id', 'stock_id', 'currency', 'store_id'), 
    ...
    $connection->addKey($productTierPriceTable, 'UNQ_CATALOG_PRODUCT_TIER_PRICE', array(
        'entity_id', 'all_groups', 'customer_group_id', 'qty', 'website_id', 'stock_id', 'currency', 'store_id'
    ), 'unique');
}
...
$connection->addKey($productIndexTierPriceTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceFinalIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceFinalTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceBundleIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceBundleTmpTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceBundleSelectionIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'option_id', 'selection_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceBundleOptionIdxTable, 'PRIMARY', array(
    'entity_id', 'customer_group_id', 'website_id', 'option_id', 'stock_id', 'currency', 'store_id'
), 'primary');
...
$connection->addKey($productIndexPriceCfgOptionAggregateIdxTable, 'PRIMARY', array(
    'parent_id', 'child_id', 'customer_group_id', 'website_id', 'stock_id', 'currency', 'store_id'
), 'primary');
