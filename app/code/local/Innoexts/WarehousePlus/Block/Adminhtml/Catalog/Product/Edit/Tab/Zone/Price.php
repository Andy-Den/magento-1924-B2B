 ...
 */
class Innoexts_WarehousePlus_Block_Adminhtml_Catalog_Product_Edit_Tab_Zone_Price 
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface 
{
     ...
     * @var string
     */
    protected $_gridBlockType = 'warehouseplus/adminhtml_catalog_product_edit_tab_zone_price_grid';
    /**
     * Form block
     * 
     * @var string
     */
    protected $_formBlockType = 'warehouseplus/adminhtml_catalog_product_edit_tab_zone_price_form';
    /**
     * Tab title
     * 
     * @var string
