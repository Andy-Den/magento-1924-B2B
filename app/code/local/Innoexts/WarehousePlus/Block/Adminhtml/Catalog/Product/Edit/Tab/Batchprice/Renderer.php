 ...
 */
class Innoexts_WarehousePlus_Block_Adminhtml_Catalog_Product_Edit_Tab_Batchprice_Renderer 
    extends Innoexts_Warehouse_Block_Adminhtml_Catalog_Product_Edit_Tab_Batchprice_Renderer 
{
    /**
     * Constructor
     */
