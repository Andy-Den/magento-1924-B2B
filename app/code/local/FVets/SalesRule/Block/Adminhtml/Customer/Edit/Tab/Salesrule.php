 ...
 */
class FVets_SalesRule_Block_Adminhtml_Customer_Edit_Tab_Salesrule extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'base_link' => 'adminhtml/salesrule_salesrule/edit',
            )
        );
		$this->addColumn(
			'rule_type',
