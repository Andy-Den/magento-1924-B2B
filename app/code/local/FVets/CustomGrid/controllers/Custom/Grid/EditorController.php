...
class FVets_CustomGrid_Custom_Grid_EditorController
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        if (($gridModel = $this->_initGridModel())
            ...
            //&& $gridModel->checkUserActionPermission(FVets_CustomGrid_Model_Grid::GRID_ACTION_EDIT_COLUMNS_VALUES, true)
