...
class FVets_CustomGrid_Block_Options_Source_Edit_Tab_Model
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $block->addFieldDependence(
            ...
            'return_type', 
            array(
                FVets_CustomGrid_Model_Options_Source::SOURCE_MODEL_RETURN_TYPE_OPTIONS_ARRAY,
                FVets_CustomGrid_Model_Options_Source::SOURCE_MODEL_RETURN_TYPE_VO_COLLECTION,
            )
        );
