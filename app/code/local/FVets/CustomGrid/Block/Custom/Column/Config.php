...
class FVets_CustomGrid_Block_Custom_Column_Config
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'onclick', 'fvetscgCustomColumnForm.insertParams()');
        
        $this->_formScripts[] = 'fvetscgCustomColumnForm = new fvetscg.CustomColumn.Form("custom_column_config_options_form", "'
