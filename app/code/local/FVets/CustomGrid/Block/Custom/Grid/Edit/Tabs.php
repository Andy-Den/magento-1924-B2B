...
class FVets_CustomGrid_Block_Custom_Grid_Edit_Tabs
    extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($grid->checkUserActionPermission(FVets_CustomGrid_Model_Grid::GRID_ACTION_CUSTOMIZE_COLUMNS)) {
    ...
    {
        if (!$this->_getData('custom_grid') instanceof FVets_CustomGrid_Model_Grid) {
