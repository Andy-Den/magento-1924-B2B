...
class FVets_CustomGrid_Block_Widget_Grid_Column_Filter_Product_Categories_Chooser
    extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('fvets/customgrid/widget/grid/column/filter/product/categories/chooser.phtml');
    }
        ...
        if ($this->getJsObject()) {
            return $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick' => 'fvetscgApplyCategories();',
                    'class'   => 'scalable save',
                    'type'    => 'button',
                ))->toHtml();
        } else {
