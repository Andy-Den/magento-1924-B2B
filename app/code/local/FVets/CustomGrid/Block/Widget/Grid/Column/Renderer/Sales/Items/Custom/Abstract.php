...
abstract class FVets_CustomGrid_Block_Widget_Grid_Column_Renderer_Sales_Items_Custom_Abstract
    extends FVets_CustomGrid_Block_Widget_Grid_Column_Renderer_Sales_Items_Abstract
{
    ...
    {
        $name  = 'fvetscg_wgcrsica_renderer_'.str_replace('/', '_', $type);
        $block = false;
        ...
        if (!$this->getData('failed_renderers/'.$name)) {
            ...
            if (!$block) {
                ...
                if (!$block instanceof FVets_CustomGrid_Block_Widget_Grid_Column_Renderer_Sales_Items_Sub_Interface) {
