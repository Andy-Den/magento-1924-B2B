...
class FVets_CustomGrid_Block_Widget_Grid_Form_Container
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->setTemplate('fvets/customgrid/widget/grid/form/container.phtml');
        
        $this->_addButton('save', array(
            'label'     => Mage::helper('adminhtml')->__('Save'),
            'onclick'   => 'fvetscgGridEditForm.submit();',
            'class'     => 'save',
        ), 1);
    }
