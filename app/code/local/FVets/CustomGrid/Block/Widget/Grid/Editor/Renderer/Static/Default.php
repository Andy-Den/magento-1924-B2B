...
class FVets_CustomGrid_Block_Widget_Grid_Editor_Renderer_Static_Default
    extends FVets_CustomGrid_Block_Widget_Grid_Editor_Renderer_Abstract
{
    ...
    {
        // Must work the same way as edit block (see FVets_CustomGrid_Block_Widget_Grid_Form_Static_Default)
        $cbKey = $key.'_callback';
