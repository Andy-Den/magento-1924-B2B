...
abstract class FVets_CustomGrid_Block_Widget_Grid_Form
    extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {
        parent::_construct();
        $this->setTemplate('fvets/customgrid/widget/grid/form.phtml');
    }
    ...
    protected function _createForm()
    {
        $form = new Varien_Data_Form(array(
            'id'     => Mage::helper('core')->uniqHash('fvetscg_grid_form'),
            'method' => 'post', // Needed to get form key if using container
        ));
        $form->setHtmlIdPrefix(Mage::helper('core')->uniqHash('fvetscg_grid_form_'));
