...
class FVets_CustomGrid_Block_Widget_Grid_Column_Renderer_Sales_Items_Sub_Abstract
    extends Mage_Adminhtml_Block_Template
    implements FVets_CustomGrid_Block_Widget_Grid_Column_Renderer_Sales_Items_Sub_Interface
{
