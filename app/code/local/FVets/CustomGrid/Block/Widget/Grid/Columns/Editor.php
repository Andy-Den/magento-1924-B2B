...
class FVets_CustomGrid_Block_Widget_Grid_Columns_Editor
    extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('fvets/customgrid/widget/grid/columns/editor.phtml');
    }
    ...
    protected function _toHtml()
    {
        if (!$this->getIsNewGridModel()
            && ($model = $this->getGridModel())
            && $model->checkUserActionPermission(FVets_CustomGrid_Model_Grid::GRID_ACTION_EDIT_COLUMNS_VALUES)
