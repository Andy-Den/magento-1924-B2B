...
abstract class FVets_CustomGrid_Block_Column_Renderer_Abstract
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'onclick', 'fvetscgRendererConfig.insertParams()');
        
        $this->_formScripts[] = 'fvetscgRendererConfig = new fvetscg.Renderer.Config("' . $this->_getFormId() . '", "'
