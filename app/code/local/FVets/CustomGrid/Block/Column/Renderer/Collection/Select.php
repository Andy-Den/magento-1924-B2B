...
class FVets_CustomGrid_Block_Column_Renderer_Collection_Select
    extends FVets_CustomGrid_Block_Column_Renderer_Select_Abstract
{
    ...
    {
        parent::_construct();
        $this->setTemplate('fvets/customgrid/column/renderer/collection/select.phtml');
    }
