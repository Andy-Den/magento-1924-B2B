...
class FVets_CustomGrid_Block_Messages
    extends Mage_Adminhtml_Block_Messages
{
    ...
    {
        $this->setTemplate('fvets/customgrid/messages.phtml');
        ...
        if (!is_null($type)) {
            ...
            if ($messages = $this->getMessages($type)) {
                ...
                foreach ($datedMessages as $date => $messages) {
                    $html .= '<div class="fvetscg-messages-content-date">' . $this->_formatDate($date) . '</div>';
