...
class FVets_CustomGrid_Model_Column_Renderer_Collection_Price
    extends FVets_CustomGrid_Model_Column_Renderer_Collection_Abstract
{
    ...
    protected function _getCurrencyValues($baseCode, $store, $grid)
    {
        ...
        if (($currency = $this->_getData($baseCode.'_currency')) == self::CURRENCY_TYPE_BASE) {
            ...
            if (($columnType == FVets_CustomGrid_Model_Grid::GRID_COLUMN_ORIGIN_ATTRIBUTE)
                || ($columnType == FVets_CustomGrid_Model_Grid::GRID_COLUMN_ORIGIN_CUSTOM)) {
