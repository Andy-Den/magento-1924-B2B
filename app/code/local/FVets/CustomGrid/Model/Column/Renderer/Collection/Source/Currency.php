...
class FVets_CustomGrid_Model_Column_Renderer_Collection_Source_Currency
{
    ...
    public function toOptionArray()
    {
        if (is_null($this->_optionArray)) {
            ...
            array_unshift($options, 
                array(
                    'value' => FVets_CustomGrid_Model_Column_Renderer_Collection_Price::CURRENCY_TYPE_BASE,
                    'label' => Mage::helper('customgrid')->__('Use Base Currency'),
                ), 
                array(
                    'value' => FVets_CustomGrid_Model_Column_Renderer_Collection_Price::CURRENCY_TYPE_COLUMN,
