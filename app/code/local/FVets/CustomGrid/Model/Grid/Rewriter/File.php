...
class FVets_CustomGrid_Model_Grid_Rewriter_File
    extends FVets_CustomGrid_Model_Grid_Rewriter_Abstract
{
    protected function _rewriteGrid($fvetscgClass, $originalClass, $gridType)
    {
        $classParts = explode('_', str_replace($this->_getBlcgClassPrefix(), '', $fvetscgClass));
 ...
 * @category   FVets
 * @package    FVets_CustomGrid
 * @copyright  Copyright (c) ' . date('Y') . ' Benoît Leulliette <carlos.farah@gmail.com>
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

';
        
        $content .= $this->_getRewriteCode($fvetscgClass, $originalClass, $gridType);
