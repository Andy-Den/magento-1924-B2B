...
abstract class FVets_CustomGrid_Model_Grid_Type_Abstract extends Varien_Object
{
    /**
    ...
    * @param FVets_CustomGrid_Model_Grid $model Grid Model
    * @return bool
    */
    ...
    * - "header"   : header title
    * - "width"    : width
    * - "align"    : alignment (must correspond to FVets_CustomGrid_Model_Grid aligment constants)
    ...
    */
    public function getAvailableAttributes($type, $withEditableFlag=false)
    {
        if (!isset($this->_attributes[$type])) {
            ...
            Mage::dispatchEvent('fvetscg_grid_type_available_attributes', array(
                'response'   => $response,
                'type_model' => $this,
                'block_type' => $type,
            ));
    ...
    */
    ...
    protected function _getCustomColumns()
    {
        if (is_null($this->_customColumns)) {
            ...
            Mage::dispatchEvent('fvetscg_grid_type_additional_columns', array(
                'response'   => $response,
                'type_model' => $this,
            ));
            ...
            $this->_customColumns = array_filter(
                ...
                create_function('$m', 'return ($m instanceof FVets_CustomGrid_Model_Custom_Column_Abstract);')
            );
    ...
    */
    protected function _getEditableFields($type)
    {
        ...
        Mage::dispatchEvent('fvetscg_grid_type_additional_editable_fields', array(
            'response'   => $response,
            'type_model' => $this,
            'block_type' => $type,
        ));
    ...
    */
    protected function _getEditableAttributes($type)
    {
        ...
        Mage::dispatchEvent('fvetscg_grid_type_additional_editable_attributes', array(
            'response'   => $response,
            'type_model' => $this,
            'block_type' => $type,
        ));
    ...
    */
    protected function _getEditableAttributeFields($type)
    {
        ...
        Mage::dispatchEvent('fvetscg_grid_type_additional_editable_attribute_fields', array(
            'response'   => $response,
            'type_model' => $this,
            'block_type' => $type,
        ));
    ...
    */
    public function getEditableValues($type, $origin=null)
    {
        if (!isset($this->_editableValues[$type])) {
            ...
            Mage::dispatchEvent('fvetscg_grid_type_editable_fields', array(
                'response'   => $fieldsResponse,
                'type_model' => $this,
                'block_type' => $type,
            ));
            Mage::dispatchEvent('fvetscg_grid_type_editable_attributes', array(
                'response'   => $attributesResponse,
                'type_model' => $this,
                'block_type' => $type,
            ));
            Mage::dispatchEvent('fvetscg_grid_type_editable_attribute_fields', array(
    ...
    * @param FVets_CustomGrid_Model_Grid $gridModel Custom grid model
    * @return array
    */
    ...
    * 
    * @param string $type Grid block type
    * @param FVets_CustomGrid_Model_Grid Grid model
    ...
    */
    ...
    {
        return $model->checkUserActionPermission(FVets_CustomGrid_Model_Grid::GRID_ACTION_EDIT_COLUMNS_VALUES);
    }
    ...
    * @param array $params Edit parameters
    * @param mixed $entity Edited entity
    * @param FVets_CustomGrid_Model_Grid $model Custom grid model
    * @return bool
    */
    ...
    */
    ...
    {
        $this->_dispatchSaveEvent($type, $config, $params, $entity, $value, 'fvetscg_grid_type_before_save_field_value');
        return $this;
    }
    ...
    */
    protected function _afterSaveEditedFieldValue($type, $config, $params, $entity, $value, $result)
    {
        ...
        $this->_dispatchSaveEvent($type, $config, $params, $entity, $value, 'fvetscg_grid_type_after_save_field_value');
        return $this;
    }
    ...
    */
    ...
    {
        $this->_dispatchSaveEvent($type, $config, $params, $entity, $value, 'fvetscg_grid_type_before_save_attribute_value');
        return $this;
    }
    ...
    */
    protected function _afterSaveEditedAttributeValue($type, $config, $params, $entity, $value, $result)
    {
        ...
        $this->_dispatchSaveEvent($type, $config, $params, $entity, $value, 'fvetscg_grid_type_after_save_attribute_value');
        return $this;
    }
