...
class FVets_CustomGrid_Model_Custom_Column_Product_Inventory
    extends FVets_CustomGrid_Model_Custom_Column_Simple_Table
{
    ...
    protected function _getForcedGridValues($block, $model, $id, $alias, $params, $store, $renderer=null)
    {
        return array_merge(
            array(
                ...
                'fvetscg_table_flag_key' => $this->getAppliedFlagKey($alias, $params, $block, $block->getCollection(), $this->getTableName()),
                'fvetscg_filter_params'  => $params,
