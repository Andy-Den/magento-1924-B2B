...
abstract class FVets_CustomGrid_Model_Custom_Column_Order_Items_Abstract
    extends FVets_CustomGrid_Model_Custom_Column_Sales_Items_Abstract
{
    public function addItemsToGridCollection($alias, $params, $block, $collection, $firstTime)
    {
        if (!$firstTime && !$block->fvetscg_isExport()) {
            ...
            $items = $this->_getOrdersItemsCollection($ordersIds, true, 'fvetscg_custom_column_order_items_list_order_items_collection');
