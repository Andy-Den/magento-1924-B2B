...
abstract class FVets_CustomGrid_Model_Custom_Column_Creditmemo_Items_Abstract
    extends FVets_CustomGrid_Model_Custom_Column_Sales_Items_Abstract
{
    public function addItemsToGridCollection($alias, $params, $block, $collection, $firstTime)
    {
        if (!$firstTime && !$block->fvetscg_isExport()) {
            ...
            $ordersItems = $this->_getOrdersItemsCollection($ordersIds, false, 'fvetscg_custom_column_creditmemo_items_list_order_items_collection');
