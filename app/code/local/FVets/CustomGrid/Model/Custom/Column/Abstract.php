...
abstract class FVets_CustomGrid_Model_Custom_Column_Abstract
    extends Varien_Object
{
    ...
    protected function _prepareGridCollection($collection, $block, $model, $id, $alias, $params, $store, $renderer=null)
    {
        ...
        if ($this->_getBaseHelper()->isMageVersionGreaterThan(1, 6)
            ...
            * Note that this does not affect filters applied on custom columns derived from FVets_CustomGrid_Model_Custom_Column_Simple_Abstract,
