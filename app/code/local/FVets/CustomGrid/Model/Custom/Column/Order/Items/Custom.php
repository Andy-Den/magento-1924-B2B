...
class FVets_CustomGrid_Model_Custom_Column_Order_Items_Custom
    extends FVets_CustomGrid_Model_Custom_Column_Order_Items_Abstract
{
    ...
    public function getItemValues()
    {
        if (!$this->hasData('item_values')) {
            ...
            $this->setData('item_values', $this->_getItemValuesList($baseValues, $amountsKeys, 'fvetscg_custom_column_order_items_custom_values'));
        }
