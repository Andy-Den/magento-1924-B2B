...
class FVets_CustomGrid_Model_Options_Source
    extends Mage_Core_Model_Abstract
{
    ...
    static public function getPredefinedTypes()
    {
        if (!is_array(self::$_predefinedTypes)) {
            ...
            Mage::dispatchEvent('fvetscg_options_source_predefined_types', array('response' => $response));
