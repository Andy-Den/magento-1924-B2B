 ...
 */
/**
 * tableprice - categories relation edit block
 *
 * @category    FVets
 * @package     FVets_TablePrice
 * @author      Douglas Ianitsky
 */
class FVets_TablePrice_Block_Adminhtml_Tableprice_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('fvets_tableprice/tableprice/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited table price
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the table price is linked to
     *
     * @access public
     * @return array
     * @author Douglas Ianitsky
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getTableprice()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param FVets_TablePrice_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current table price)
     *
     * @return array
     */
