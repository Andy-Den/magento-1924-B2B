 ...
 * @package     FVets_Payment
 */
class FVets_Salesrep_Block_Adminhtml_Salesrep_Edit_Tab_Customer extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    protected function _prepareCollection()
    {
		...
		$collection->addAttributeToSelect('razao_social');
        //Customer name
		...
		//$collection->addAttributeToFilter('fvets_salesrep',array("finset"=>array($this->getSalesrep()->getId())));
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn(
			'razao_social',
			array(
				'header' => Mage::helper('customer')->__('Razão Social'),
				'align'  => 'left',
				'index'  => 'razao_social',
				'renderer'  => 'fvets_payment/adminhtml_helper_column_renderer_relation',
				'params'    => array(
    ...
    {
        $customers = $this->getSalesrepCustomers();
    ...
    {
        $customers = array();
        $selected = Mage::registry('fvets_salesrep')->getSelectedCustomers();
