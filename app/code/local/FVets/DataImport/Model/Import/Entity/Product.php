 ...
 */
class FVets_DataImport_Model_Import_Entity_Product extends Mage_ImportExport_Model_Import_Entity_Product
{
    /**
     ...
     *
     * @param array $source
     * @return FVets_DataImport_Model_Import_Entity_Product
     */
    ...
    protected function _initCategories()
    {
        ...
        Mage::dispatchEvent( 'avs_fvetsdataimport_entity_product_init_categories', array('transport' => $transportObject) );
    ...
    protected function _reindexUpdatedProducts()
    {
        ...
        Mage::dispatchEvent('fvetsdataimport_reindex_products_before_indexer_stock', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('cataloginventory/indexer_stock')->catalogProductMassAction($event);

        Mage::dispatchEvent('fvetsdataimport_reindex_products_before_product_indexer_price', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('catalog/product_indexer_price')->catalogProductMassAction($event);

        Mage::dispatchEvent('fvetsdataimport_reindex_products_before_category_indexer_product', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('catalog/category_indexer_product')->catalogProductMassAction($event);

        Mage::dispatchEvent('fvetsdataimport_reindex_products_before_product_indexer_eav', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('catalog/product_indexer_eav')->catalogProductMassAction($event);

        Mage::dispatchEvent('fvetsdataimport_reindex_products_before_fulltext', array('entity_id' => &$entityIds));
        ...
        if (Mage::getResourceModel('ecomdev_urlrewrite/indexer')) {
            Mage::dispatchEvent('fvetsdataimport_reindex_products_before_ecomdev_urlrewrite', array('entity_id' => &$entityIds));
            Mage::getResourceSingleton('ecomdev_urlrewrite/indexer')->updateProductRewrites($entityIds);
        } else {
            Mage::dispatchEvent('fvetsdataimport_reindex_products_before_urlrewrite', array('entity_id' => &$entityIds));
        ...
        Mage::dispatchEvent('fvetsdataimport_reindex_products_before_flat', array('entity_id' => &$entityIds));
        Mage::getSingleton('catalog/product_flat_indexer')->saveProduct($entityIds);

        Mage::dispatchEvent('fvetsdataimport_reindex_products_after', array('entity_id' => &$entityIds));
     ...
     * See https://github.com/avstudnitz/FVets_DataImport/issues/3
     *
     * @return Mage_ImportExport_Model_Import_Entity_Product
     */
     ...
     * Behavior can be turned off with config setting "fvetsdataimport/general/clear_field_on_empty_string"
     * You can define a string which can be used for clearing a field, configured in "fvetsdataimport/product/symbol_for_clear_field"
     *
     * @param array $rowData
     */
     ...
     *
     * @see https://github.com/avstudnitz/FVets_DataImport/issues/109
