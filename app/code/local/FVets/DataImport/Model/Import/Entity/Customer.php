 ...
 */
class FVets_DataImport_Model_Import_Entity_Customer extends Mage_ImportExport_Model_Import_Entity_Customer
{
    /**
    ...
    {
        parent::__construct();
        $this->_addressEntity = Mage::getModel('fvetsdataimport/import_entity_customer_address', $this);
    }
