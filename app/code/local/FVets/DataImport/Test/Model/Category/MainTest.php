...
class FVets_DataImport_Test_Model_Category_MainTest extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function createCategoryTree($values)
    {
        ...
        $import = Mage::getModel('fvetsdataimport/import');
    ...
    {
        $collection = Mage::getModel('catalog/category')->getCollection();
        /** @var FVets_DataImport_Model_Import $import */
        $import = Mage::getModel('fvetsdataimport/import');
