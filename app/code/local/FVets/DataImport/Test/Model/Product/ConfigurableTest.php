...
class FVets_DataImport_Test_Model_Product_ConfigurableTest extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function createProduct($values)
    {
        ...
        Mage::getModel('fvetsdataimport/import')->setDropdownAttributes(array('color'))->processProductImport($values);
