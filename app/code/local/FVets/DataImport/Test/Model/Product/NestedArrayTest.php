...
class FVets_DataImport_Test_Model_Product_NestedArrayTest extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function createProduct($values)
    {
        ...
        Mage::getModel('fvetsdataimport/import')->setUseNestedArrays(true)->processProductImport($values);
