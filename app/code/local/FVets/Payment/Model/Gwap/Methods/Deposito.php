...
class FVets_Payment_Model_Gwap_Methods_Deposito extends  Allpago_Gwap_Model_Methods_Deposito
{
	...
	public function validateAutorize(Varien_Object $payment, $amount)
	{
		...
		$parameters = mage::helper('gwap')->setOrder($order)->prepareData( $data->getGwapDepositoType() );
		...
		$data->setIdErp(Mage::getStoreConfig('allpago/gwap_deposito/id_erp'));
