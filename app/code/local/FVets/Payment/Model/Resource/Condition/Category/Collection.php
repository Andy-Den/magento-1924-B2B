 ...
 */
class FVets_Payment_Model_Resource_Condition_Category_Collection extends Mage_Catalog_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('fvets_payment/condition_category')),
