 ...
 */
/**
 * condition - categories relation edit block
 *
 * @category    FVets
 * @package     FVets_Payment
 * @author      Douglas Borella Ianitsky
 */
class FVets_Payment_Block_Adminhtml_Condition_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('fvets_payment/condition/edit/tab/categories.phtml');
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getCondition()->getSelectedCategories();
            $ids = array();
