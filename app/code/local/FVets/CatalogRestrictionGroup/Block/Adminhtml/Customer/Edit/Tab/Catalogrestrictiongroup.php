 ...
 */
/**
 * Restriction Group tab on customer edit form
 *
 * @category    FVets
 * @package     FVets_CatalogRestrictionGroup
 * @author      Douglas Ianitsky
 */
class FVets_CatalogRestrictionGroup_Block_Adminhtml_Customer_Edit_Tab_Catalogrestrictiongroup extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    public function __construct()
    {
		...
		$this->setDefaultFilter( array('in_catalogrestrictiongroups' => ''));
    }
     ...
     *
     * @access protected
     * @return FVets_CatalogRestrictionGroup_Block_Adminhtml_Customer_Edit_Tab_Catalogrestrictiongroup
     * @author Douglas Ianitsky
     */
    protected function _prepareCollection()
    {
        ...
        if ($this->getCustomer()->getId()) {
            $collection->addFieldToFilter('website_id', $this->getCustomer()->getWebsiteId());
            $constraint = 'related.customer_id='.$this->getCustomer()->getId();
        } else {
            $constraint = 'related.customer_id=0';
        }
        $collection->getSelect()->joinLeft(
            array('related' => $collection->getTable('fvets_catalogrestrictiongroup/entity_customer')),
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'base_link' => 'adminhtml/catalogrestrictiongroup/edit',
            )
        );
        $this->addColumn(
            'position',
    ...
    {
        $catalogrestrictiongroups = $this->getCustomerCatalogrestrictiongroups();
    ...
    public function getSelectedCatalogrestrictiongroups()
    {
        ...
        $selected = Mage::helper('fvets_catalogrestrictiongroup/customer')->getSelectedCatalogrestrictiongroups(Mage::registry('current_customer'));
