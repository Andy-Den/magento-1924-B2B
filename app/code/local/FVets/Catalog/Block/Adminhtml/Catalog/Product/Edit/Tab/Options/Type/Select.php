...
class FVets_Catalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Select extends
    FVets_Catalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Abstract
{
    /**
     * Class constructor
     */
    ...
    {
        $this->getChild('option_action')
            ->setData('id', 'product_option_{{id}}_select_{{select_id}}_action')
            ->setName('product[options][{{id}}][values][{{select_id}}][action]');

        return parent::getActionSelectHtml();
    }
}