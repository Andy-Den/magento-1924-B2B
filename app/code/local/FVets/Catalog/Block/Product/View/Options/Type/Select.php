<?php
class FVets_Catalog_Block_Product_View_Options_Type_Select
    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                if ($_value->getAction() == 'increase') {
                    $optionStr = $this->__('%s: %s unit(s) | increase of %s per unit', $_value->getTitle(), $_value->getMultiplyFactor(), $priceStr);
                } else {
                    $optionStr = $this->__('%s: %s unit(s) | decrease of %s per unit', $_value->getTitle(), $_value->getMultiplyFactor(), $priceStr);
                }
